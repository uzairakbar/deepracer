...
from deepracer.service.spec import SimSpec, DEFAULT_IMAGE
from deepracer.service.backends import SimBackend, SimHandle, detect_backend
...
class SimulationManager:
    ...
    def _warn_existing(self) -> None:
        ...
        if existing:
            ...
            logger.warning(
                ...
                f'session are stale — run `python -m deepracer.clean` to '
    ...
    def shutdown_all(self) -> None:
        ...
        Runs on interpreter exit (atexit) and via deepracer.shutdown_all().
